...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "ageRestrictionMessage":
            MessageLookupByLibrary.simpleMessage("您必須年滿 18 歲才能使用此功能"),
        "ageRestrictionTitle": MessageLookupByLibrary.simpleMessage("年齡限制"),
        "albumPermissionRequired":
            MessageLookupByLibrary.simpleMessage("需要相簿權限才能存檔"),
        ...
        "canvasAspectRatio": MessageLookupByLibrary.simpleMessage("畫布比例"),
        ...
        "editorAddImageObjectTooltip":
            MessageLookupByLibrary.simpleMessage("新增圖片物件"),
        "editorBackgroundSettingTooltip":
            MessageLookupByLibrary.simpleMessage("背景設定"),
        "editorBorderSettingsTooltip":
            MessageLookupByLibrary.simpleMessage("框線設定"),
        "editorCanvasBackgroundSetting":
            MessageLookupByLibrary.simpleMessage("畫布背景設定"),
        ...
        "editorDiscardMessage":
            MessageLookupByLibrary.simpleMessage("返回後目前的拼貼內容不會保留，需要重新編輯。"),
        ...
        "editorLayoutSettingsTooltip":
            MessageLookupByLibrary.simpleMessage("更換排版"),
        "editorOrPickSolidColor":
            MessageLookupByLibrary.simpleMessage("或選擇單色背景："),
        "editorPhotoSelectionRequired":
            MessageLookupByLibrary.simpleMessage("請從首頁選擇 2～12 張照片。"),
        "editorPickBackgroundImage":
            MessageLookupByLibrary.simpleMessage("從相片庫選擇底圖圖片"),
        "editorReselectMessage":
            MessageLookupByLibrary.simpleMessage("重新選擇後，目前的拼貼排版與編輯內容會被清除。"),
        ...
        "editorSaveToAlbumTooltip":
            MessageLookupByLibrary.simpleMessage("儲存至相簿"),
        ...
        "pickerLoadFailed":
            MessageLookupByLibrary.simpleMessage("部分照片無法載入，請重新選擇。"),
        "pickerMinimumHint":
            MessageLookupByLibrary.simpleMessage("請選擇 2～12 張照片"),
        "pickerOpenSettings": MessageLookupByLibrary.simpleMessage("開啟設定"),
        "pickerTitle": MessageLookupByLibrary.simpleMessage("選擇照片"),
        "purchaseFailed": MessageLookupByLibrary.simpleMessage("購買失敗，請稍後再試。"),
        ...
        "settingOneTimePurchaseForever":
            MessageLookupByLibrary.simpleMessage("一次購買，永久去除"),
        "settingPrivacyPolicyAndTerms":
            MessageLookupByLibrary.simpleMessage("隱私權政策與使用條款"),
        ...
        "subscriptionActive": MessageLookupByLibrary.simpleMessage("去廣告訂閱已啟用"),
        "subscriptionAndroidOnly":
            MessageLookupByLibrary.simpleMessage("目前裝置不支援訂閱。"),
        ...
        "subscriptionHeadline":
            MessageLookupByLibrary.simpleMessage("享受無廣告的 PicGrid"),
        "subscriptionPerMonth": MessageLookupByLibrary.simpleMessage("/ 月"),
        "subscriptionPlanPreparing":
            MessageLookupByLibrary.simpleMessage("訂閱方案準備中"),
        "subscriptionProductUnavailable": MessageLookupByLibrary.simpleMessage(
            "找不到訂閱方案，請確認商品已在商店啟用，且測試帳號具備購買資格。"),
        "subscriptionPurchaseCanceled":
            MessageLookupByLibrary.simpleMessage("已取消購買。"),
        "subscriptionPurchasePending":
            MessageLookupByLibrary.simpleMessage("交易正在處理中…"),
        "subscriptionPurchaseSuccess":
            MessageLookupByLibrary.simpleMessage("訂閱成功，廣告已移除。"),
        "subscriptionRenewalNotice": MessageLookupByLibrary.simpleMessage(
            "訂閱期間為 1 個月。價格與訂閱週期將以商店顯示資訊為準。自動續訂方案可隨時至商店帳號設定取消。"),
        "subscriptionRestore": MessageLookupByLibrary.simpleMessage("恢復購買"),
        "subscriptionRestoreFailed":
            MessageLookupByLibrary.simpleMessage("無法恢復購買，請稍後再試。"),
        "subscriptionRestoreFinished":
            MessageLookupByLibrary.simpleMessage("恢復購買檢查完成。"),
        "subscriptionRestoring":
            MessageLookupByLibrary.simpleMessage("正在恢復購買…"),
        "subscriptionStoreUnavailable":
            MessageLookupByLibrary.simpleMessage("目前無法連線至商店。"),
        "subscriptionTitle": MessageLookupByLibrary.simpleMessage("去廣告訂閱"),
